package com.example.movieReco.configuration;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter { // 2
    ...
    protected void configure(HttpSecurity http) throws Exception { // 5
        http
                ...
                .authorizeRequests() // 6
                .antMatchers("/login", "/signup/**", "/resetPwdByEmailForm", "/resetPwdByEmail","/user", "/movies/**","/recommendation/**", "/message-redirect").permitAll() // 누구나 접근 허용
                ...
                .defaultSuccessUrl("/movies") // 로그인 성공 후 리다이렉트 주소
                .and()
                .logout() // 8
    ...
    public void configure(AuthenticationManagerBuilder auth) throws Exception { // 9
        System.out.println("login authentication process");
